...
<Image src="Images/Climate_resilience_base_year2080.png" width="25%" float="right" />
...
## Implementation
This is done in practice through Python scripts, in two steps:
...
2. We run through each years csv and generate a texture 

## Limitations
There are of course some limitations to this method:
